...
u16 PPU_ColorBuffer[256*2]; // interleaved color buffer; even=main, odd=sub
...
void PPU_Reset()
{
	...
	Result res;
	if (!fbCopyThread)
		res = svc_createThread(&fbCopyThread, PPU_FBCopyThread, 0, (u32*)&fbCopyThreadStack[0x400], 0x3F, 1);
